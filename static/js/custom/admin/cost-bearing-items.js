(function (window) {
  ...
  NOVA.cbi_uom_list = ko.observableArray([]);
  ...
  NOVA.getCbiUomList = function(){
    var csrftoken = NOVA.getCookie('csrftoken');
    $.ajax({
      method: 'GET',
      url: '/api/admin/cbi/uom/list/get',
    ...
    .done( function (d, textStatus, jqXHR) {
      ...
      for(var i=0; i< d.data.length; i++){
        NOVA.cbi_uom_list.push(d.data[i]);
      }
  ...
  $('.category-create-btn').on('click', function(){
    $('.cost-bear-wrapper').removeClass('d-none');
    NOVA.categoryName('');
    NOVA.categoryItems([]);
  ...
  NOVA.saveCategory = function(){
    ...
    $.ajax({
      method: 'POST',
      url: '/api/admin/cbi/category/create',
      data: formdata,
      contentType: false,
      processData: false,
      beforeSend: function(xhr, settings) {
    ...
    .done( function (d, textStatus, jqXHR) {
      $('.cost-bear-wrapper').addClass('d-none');
      NOVA.showToast(d)
      NOVA.getCbiCategoriesList();
    })
    .fail( function (jqXHR, textStatus, errorThrown) {
  ...
  NOVA.init = function(){
    ...
    $('.cost-bearing-form').each(function(){
      getId = $(this).attr('id');
      $("#"+getId).validate({
        ignore: "",
        errorElement: 'span',
  ...
  NOVA.editCategory = function(){
    ...
    $.ajax({
      method: 'POST',
      url: '/api/admin/cbi/category/edit',
      data: formdata,
      contentType: false,
      processData: false,
      beforeSend: function(xhr, settings) {
  ...
  NOVA.deleteCategory = function(data, e){
    ...
    $.ajax({
      method: 'POST',
      url: '/api/admin/cbi/category/delete',
      data: formdata,
      contentType: false,
      processData: false,
      beforeSend: function(xhr, settings) {
  ...
  NOVA.disableCategory = function(category_id){
    ...
    $.ajax({
      method: 'POST',
      url: '/api/admin/cbi/category/disable',
      data: formdata,
      contentType: false,
      processData: false,
      beforeSend: function(xhr, settings) {
  ...
  NOVA.enableCategory = function(category_id){
    ...
    $.ajax({
      method: 'POST',
      url: '/api/admin/cbi/category/enable',
      data: formdata,
      contentType: false,
      processData: false,
      beforeSend: function(xhr, settings) {
